...
class _SingleProductState extends State<SingleProduct> {
  ...
  //       productDetails = List.generate(docs.documents.length, (index) {
  //         return Product(
  //           isRecommended: docs.documents[0].data["isRecommended"],
  //           productCategory: docs.documents[0].data["product_category"],
  //           productImageUrl: docs.documents[0].data["product_image_url"],
  //           productName: docs.documents[0].data["product_name"],
  //           productPrice: docs.documents[0].data["product_price"],
  //           productSize: docs.documents[0].data["product_size"],
  //           productVendor: docs.documents[0].data["product_vendor"],
  //         );
  //       });
  //     });
  //   });
